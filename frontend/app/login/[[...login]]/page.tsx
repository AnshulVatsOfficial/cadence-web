  ...
  return (
    <div className="relative min-h-screen flex flex-col items-center justify-center bg-ds-bg-neutral-subtle px-4 sm:px-6 lg:px-8 overflow-hidden select-none">
      ...
      <div className="flex flex-col items-center mb-8 z-10">
        ...
        <p className="mt-2.5 text-sm text-ds-text-subtle font-medium">
          Log in to continue to your project
        </p>
      </div>
        ...
        <SignIn
          ...
          appearance={{
            ...
            elements: {
              ...
              headerTitle:
                "text-xl font-bold text-ds-text tracking-tight text-center",
              headerSubtitle: "text-ds-text-subtle text-sm text-center mt-1.5",
              formButtonPrimary:
                "bg-brand hover:bg-brand-hover text-white font-semibold text-sm py-2.5 px-4 rounded-ds-btn transition-colors shadow-none w-full",
              formFieldInput:
                "bg-ds-bg-neutral-subtle border-ds-border focus:border-ds-border-focus focus:bg-ds-bg text-ds-text rounded-ds-btn transition-colors text-sm w-full py-2 px-3",
              footerActionLink:
                "text-brand hover:text-brand-hover font-semibold",
              socialButtonsBlockButton:
                "border-ds-border hover:bg-ds-bg-neutral hover:border-ds-border rounded-ds-btn transition-all text-ds-text font-semibold text-sm py-2.5",
